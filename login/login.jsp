  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	...
	<div class="card align-middle" style="width:35rem; border-radius:20px;">
		...
		<%if(loginbean.login(membership)){
			...
			response.sendRedirect("../freebook/freebook_main.jsp");
		...
		<h2 class="card-title text-center" style="color:#113366;">로그인 실패</h2>
		</div>
		
		<div class="card-body" align="center"> 
        <h5 class="form-signin-heading">아이디와 비밀번호를 확인해주세요!</h5>
		<br>
